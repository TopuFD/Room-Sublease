...
class IntrovertScreen extends StatelessWidget {
  IntrovertScreen({super.key});
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  CommonText(
                    text: "Are you more of an introvert?",
                    fontSize: 24,
                    bottom: 5,
                    maxLines: 2,
                  ...
                  32.height,
                  CustomCheckbox(
                    items: makeFriend.introPref,
                    initiallySelected: makeFriend.selcectIntro,
                    isMinimum: true,
                    onSelectionChanged: (selected) {
                      makeFriend.selcectIntro.value = selected;
                    },
                  ),
                  ...
                  CommonButton(
                    titleText: "Continue",
                    onTap: () {
                      Get.toNamed(AppRoute.extrovertScreen);
                    },
                  ),
                  40.height,
                ],
