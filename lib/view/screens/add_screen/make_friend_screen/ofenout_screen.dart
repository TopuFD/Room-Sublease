...
class OfenoutScreen extends StatelessWidget {
  OfenoutScreen({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  32.height,
                  CustomCheckbox(
                    items: makeFriend.oftenPref,
                    initiallySelected: makeFriend.selcectOften,
                    isMinimum: false,
                    onSelectionChanged: (selected) {
                      makeFriend.selcectOften.value = selected;
                    },
                  ),
                  ...
                  CommonButton(
                    titleText: "Continue",
                    onTap: () {
                      Get.toNamed(AppRoute.greeklifeScreen);
                    },
                  ),
                  40.height,
                ],
