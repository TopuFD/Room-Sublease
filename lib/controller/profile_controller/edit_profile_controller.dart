...
class EditProfileController extends GetxController {
  ...
  final funyList = <Map<String, dynamic>>[
    ...
    {'title': 'Running', 'color': Color(0xFFFCD5D2), "isBorder": true},
    {
    ...
    {'title': 'Painting', 'color': Color(0xFFCBDFFF), "isBorder": true},
    {
    ...
    {'title': 'Live Music', 'color': Color(0xFFFCD5D2), "isBorder": true},
    {
      'title': 'Going to Sports Games',
      'color': Color(0xFFE8D0FC),
      "isBorder": true
    },
    {'title': 'Bar Hopping', 'color': Color(0xFFCBDFFF), "isBorder": true},
    {
      'title': 'Going To The Movie Theater',
      'color': Color(0xFFE8D0FC),
      "isBorder": false
